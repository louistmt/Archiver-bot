...
const subExecsMap = produceSubExecsMap({ definition: configArchiveDefinition, execute: configArchiveExecute }, { definition: configLogChannelDefinition, execute: configLogChannelExecute });
