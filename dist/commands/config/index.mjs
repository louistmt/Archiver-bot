...
const subExecsMap = produceSubExecsMap({ definition: configArchiveDefinition, execute: configArchiveExecute }, { definition: configLogChannelDefinition, execute: configLogChannelExecute }, { definition: listDefinition, execute: listExecute });
...
const configCmd = { definition, execute };
