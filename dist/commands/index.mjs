...
export const execsMap = produceExecsMap(archiveCmd, cancelCmd, catCmd, configCmd, jobsCmd, exportCmd, exportCatCmd);
export const definitionsList = produceDefinitionList(archiveCmd, cancelCmd, catCmd, configCmd, jobsCmd, exportCmd, exportCatCmd);
