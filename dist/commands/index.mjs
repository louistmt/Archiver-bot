...
export const execsMap = produceExecsMap(archiveCmd, cancelCmd, catCmd, configCmd, exportCmd, exportCatCmd, dumpGDocCmd);
export const definitionsList = produceDefinitionList(archiveCmd, cancelCmd, catCmd, configCmd, exportCmd, exportCatCmd, dumpGDocCmd);
